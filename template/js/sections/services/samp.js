...
{
	$.getJSON('services/section/samp/id/'+$('#unit').val()+'/tarif/'+$('#tarifs').val()+'/get/'+data, function(arr)
	{
...
function upd_price()
{
	$.getJSON('services/section/samp/id/'+$('#unit').val()+'/tarif/'+$('#tarifs').val()+'/slots/'+$('#slots').val()+'/time/'+$('#time').val()+'/get/price', function(arr)
	{
		$.each(arr, function(id, val)
		{
			$('#'+id).html(val);
...
function promo()
{
	...
	$.getJSON('services/section/samp/id/'+$('#unit').val()+'/tarif/'+$('#tarifs').val()+'/slots/'+$('#slots').val()+'/time/'+$('#time').val()+'/cod/'+$('#promo').val()+'/get/promo', function(arr)
	{

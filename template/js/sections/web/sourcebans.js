...
$('#install').ajaxForm({
    ...
    success: function (data) {
        $.each(data, function (i, val) {
            ...
            if (i == 's')
                location.href = home + 'servers/id/' + server + '/section/web/subsection/sourcebans/action/manage';
        });
...
function passwd() {
    ...
    $.getJSON(home + 'servers/id/' + server + '/section/web/subsection/sourcebans/action/passwd/go', function (arr) {
...
function update() {
    ...
    $.getJSON(home + 'servers/id/' + server + '/section/web/subsection/sourcebans/action/update/go', function (arr) {
        $.each(arr, function (i, val) {
            if (i == 'e')
                bootbox.dialog('<h3 class="red">Ошибка</h3>' + val,
                    [{
...
function delweb() {
    ...
    $.getJSON(home + 'servers/id/' + server + '/section/web/subsection/sourcebans/action/delete/go', function (arr) {
        $.each(arr, function (i, val) {
            if (i == 'e')
                bootbox.dialog('<h3 class="red">Ошибка</h3>' + val,
                    [{
...
function connect() {
    ...
    $.getJSON(home + 'servers/id/' + server + '/section/web/subsection/sourcebans/action/connect/server/' + ser + '/go', function (arr) {
        $.each(arr, function (i, val) {
            if (i == 'e')
                bootbox.dialog('<h3 class="red">Ошибка</h3>' + val,
                    [{

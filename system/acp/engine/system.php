...
if ($go) {
    ...
    if (isset($url['service']) and in_array($url['service'], ['apache2', 'nginx', 'mysql', 'unit'])) {
    ...
    $aData = ['cpu' => '0%', 'ram' => '0%', 'hdd' => '0%', 'apache' => '<a href="#" onclick="return system_restart(\'apache\')">Перезагрузить</a>', 'nginx' => '<a href="#" onclick="return system_restart(\'nginx\')">Перезагрузить</a>', 'mysql' => '<a href="#" onclick="return system_restart(\'mysql\')">Перезагрузить</a>', 'uptime' => 'unknown', 'ssh' => 'error'];

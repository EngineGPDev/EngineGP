...
$aData['login'] = isset($_POST['login']) ? trim((string) $_POST['login']) : $us['login'];
$aData['passwd'] = isset($_POST['passwd']) ? trim((string) $_POST['passwd']) : '';
$aData['mail'] = isset($_POST['mail']) ? trim((string) $_POST['mail']) : $us['mail'];
$aData['name'] = isset($_POST['name']) ? trim((string) $_POST['name']) : $us['name'];
$aData['lastname'] = isset($_POST['lastname']) ? trim((string) $_POST['lastname']) : $us['lastname'];
$aData['patronymic'] = isset($_POST['patronymic']) ? trim((string) $_POST['patronymic']) : $us['patronymic'];
$aData['contacts'] = isset($_POST['contacts']) ? trim((string) $_POST['contacts']) : $us['contacts'];
$aData['phone'] = isset($_POST['phone']) ? trim((string) $_POST['phone']) : $us['phone'];
$aData['confirm_phone'] = isset($_POST['confirm_phone']) ? trim((string) $_POST['confirm_phone']) : $us['confirm_phone'];
$aData['group'] = isset($_POST['group']) ? trim((string) $_POST['group']) : $us['group'];
$aData['balance'] = isset($_POST['balance']) ? trim((string) $_POST['balance']) : $us['balance'];
$aData['help'] = isset($_POST['help']) ? trim((string) $_POST['help']) : $us['help'];
$aData['part_money'] = isset($_POST['part_money']) ? trim((string) $_POST['part_money']) : $us['part_money'];
$aData['support_info'] = isset($_POST['support_info']) ? trim((string) $_POST['support_info']) : $us['support_info'];
$aData['level'] = isset($_POST['level']) ? trim((string) $_POST['level']) : $us['level'];
$aData['replenish'] = isset($_POST['replenish']) ? trim((string) $_POST['replenish']) : 0;
$aData['rental'] = isset($_POST['rental']) ? trim((string) $_POST['rental']) : 0;
$aData['extend'] = isset($_POST['extend']) ? trim((string) $_POST['extend']) : 0;

$arr_other = ['login' => 'логина', 'mail' => 'почты'];

$arr_other_null = ['name' => 'имени', 'lastname' => 'фамилии', 'patronymic' => 'отчества', 'contacts' => 'контактов', 'phone' => 'номера'];
...
if (strlen((string) $aData['rental']) > 4)
...
if (strlen((string) $aData['extend']) > 4)
    sys::outjs(['e' => 'Неправильно указана скидка на аренду']);

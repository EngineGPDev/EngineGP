...
if ($go) {
    ...
    $aData['sql_port'] = isset($_POST['sql_port']) ? AdminSystem::int($_POST['sql_port']) : $unit['sql_port'];
    ...
    $aData['ram'] = isset($_POST['ram']) ? AdminSystem::int($_POST['ram']) : $unit['ram'];
    $aData['test'] = isset($_POST['test']) ? AdminSystem::int($_POST['test']) : $unit['test'];
    $aData['show'] = $_POST['show'] ?? $unit['show'];
    $aData['sort'] = isset($_POST['sort']) ? AdminSystem::int($_POST['sort']) : $unit['sort'];

...
if ($go) {
    ...
    $aData['address'] = isset($_POST['address']) ? trim((string) $_POST['address']) : '';
    $aData['passwd'] = isset($_POST['passwd']) ? trim((string) $_POST['passwd']) : '';
    $aData['sql_login'] = isset($_POST['sql_login']) ? trim((string) $_POST['sql_login']) : '';
    $aData['sql_passwd'] = isset($_POST['sql_passwd']) ? trim((string) $_POST['sql_passwd']) : '';
    $aData['sql_port'] = isset($_POST['sql_port']) ? sys::int($_POST['sql_port']) : 3306;
    $aData['sql_ftp'] = isset($_POST['sql_ftp']) ? trim((string) $_POST['sql_ftp']) : '';
    ...
    $aData['domain'] = isset($_POST['domain']) ? trim((string) $_POST['domain']) : '';

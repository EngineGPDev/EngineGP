...
if ($go) {
    ...
    $aData['service'] = isset($_POST['service']) ? explode('_', (string) $_POST['service']) : exit();
    $aData['title'] = isset($_POST['title']) ? strip_tags(trim((string) $_POST['title'])) : '';
    ...
    */
    ...
    // Проверка сообщения
    if (iconv_strlen((string) $aData['text'], 'UTF-8') < 10 || iconv_strlen((string) $aData['text'], 'UTF-8') > 1000)

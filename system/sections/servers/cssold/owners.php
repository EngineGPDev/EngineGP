...
$aAccessI = ['start' => 'Включение', 'stop' => 'Выключение', 'restart' => 'Перезагрузка', 'change' => 'Смена карты', 'reinstall' => 'Переустановка', 'update' => 'Обновление', 'console' => 'Раздел "Консоль"', 'settings' => 'Раздел "Настройки"', 'plugins' => 'Раздел "Плагины"', 'maps' => 'Раздел "Карты"'];

$aAccess = ['start', 'stop', 'restart', 'change', 'reinstall', 'update', 'console', 'settings', 'plugins', 'maps'];
...
if ($go) {
    ...
    $aDate = isset($aData['\'time\'']) ? explode('.', (string) $aData['\'time\'']) : explode('.', date('d.m.Y', $start_point));

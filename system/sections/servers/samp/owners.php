...
$aAccessI = ['start' => 'Включение', 'stop' => 'Выключение', 'restart' => 'Перезагрузка', 'reinstall' => 'Переустановка', 'console' => 'Раздел "Консоль"', 'settings' => 'Раздел "Настройки"', 'plugins' => 'Раздел "Плагины"'];

$aAccess = ['start', 'stop', 'restart', 'reinstall', 'console', 'settings', 'plugins'];

...
class service
{
    public static function buy($aData = [])
    {
        ...
        $price = $aPrice[array_search($aData['tickrate'], explode(':', (string) $tarif['tickrate']))];
        ...
        $promo = games::define_promo(
            $aData['promo'],
            ['tarif' => $aData['tarif'], 'tickrate' => $aData['tickrate'], 'slots' => $aData['slots'], 'time' => $aData['time'], 'user' => $user['id']],
            $tarif['discount'],
            $sum
        );

...
class cron
{
    ...
    public static $process = ['cs' => 'hlds_', 'cssold' => 'srcds_i686', 'css' => 'srcds_', 'csgo' => 'srcds_', 'samp' => 'samp', 'crmp' => 'samp', 'mta' => 'mta', 'mc' => 'java'];

    public static $quakestat = ['cs' => 'a2s', 'cssold' => 'a2s', 'css' => 'a2s', 'csgo' => 'a2s', 'mta' => 'eye'];

    public static $admins_file = ['cs' => 'cstrike/addons/amxmodx/configs/users.ini', 'cssold' => 'cstrike/addons/sourcemod/configs/admins_simple.ini', 'css' => 'cstrike/addons/sourcemod/configs/admins_simple.ini', 'csgo' => 'csgo/addons/sourcemod/configs/admins_simple.ini'];
